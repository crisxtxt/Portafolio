# Cristina Vargas · Portafolio de Arquitectura

Portafolio digital SPA de **Cristina Vargas Arquitectura** — arquitectura residencial, rehabilitación de lofts y paisajismo. Explora las obras con fichas técnicas completas, comparador interactivo "obra gris vs. acabado final", visor de planos con zoom y un estimador de presupuesto por metro cuadrado.
...
- [x] Catálogo de 8 obras tipadas con filtros por categoría (URL-driven).
...
- [x] Estimador de presupuesto por m² y formulario de consultoría.
- [x] Transiciones de página cinematográficas y animaciones de scroll.
